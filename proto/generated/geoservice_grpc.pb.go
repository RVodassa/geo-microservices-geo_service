// Code generated by protoc-gen-go-grpc-server-server-server. DO NOT EDIT.
...
// is compatible with the grpc-server-server-server package it is being compiled against.
...
// It's only intended for direct use with grpc-server-server-server.RegisterService,
